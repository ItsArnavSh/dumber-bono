...
type PacketCarTelemetryData struct {
	...
	MFDPanelIndex                uint8 // 255 = MFD closed. Values are mode-dependent (see comment below)
	MFDPanelIndexSecondaryPlayer uint8 // See above
	SuggestedGear                int8  // Suggested gear for the player (1-8), 0 if none suggested
}
